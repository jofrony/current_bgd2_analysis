...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kaf_ms /home/jofrony/Dropbox/Repositories/current_bgd2/conductances/excitatory/M1RH/SPN/x86_64/kaf_ms.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Dropbox/Repositories/BasalGangliaData/data/neurons/mechanisms/kaf_ms.mod";
static const char* nmodl_file_text = 
