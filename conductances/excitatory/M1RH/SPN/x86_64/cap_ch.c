...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cap_ch /home/jofrony/Dropbox/Repositories/current_bgd2/conductances/excitatory/M1RH/SPN/x86_64/cap_ch.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Dropbox/Repositories/BasalGangliaData/data/neurons/mechanisms/cap_ch.mod";
static const char* nmodl_file_text = 
