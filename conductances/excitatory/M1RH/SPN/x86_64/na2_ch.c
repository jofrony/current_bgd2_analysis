...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na2_ch /home/jofrony/Dropbox/Repositories/current_bgd2/conductances/excitatory/M1RH/SPN/x86_64/na2_ch.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Dropbox/Repositories/BasalGangliaData/data/neurons/mechanisms/na2_ch.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "NA2_CH.MOD\n"
  "\n"
